 ...
 * ellipsoid squash → macro warp → tilted strata ledges → ridged creases →
...
export const ROCK_PRESETS = {
  ...
  // freshly-shed talus block: faceted but not box-prismatic, with surface roughness
  talus: {
...
/**
 * detail: icosphere subdivisions — 1 ≈ 80 tris, 2 ≈ 320, 3 ≈ 1280 tris.
 * StoneL uses 3 (near) / 2 (far), StoneM 2/1, StoneS 1.
 */
